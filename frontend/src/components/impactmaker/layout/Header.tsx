...
export function Header({ title, showLogo = true }: HeaderProps) {
  return (
    <header className="relative z-40 glass dark:bg-linear-to-b dark:from-black/90 dark:to-slate-900/80 dark:border-white/10 backdrop-blur-md px-4 py-3 flex items-center justify-between md:hidden">
