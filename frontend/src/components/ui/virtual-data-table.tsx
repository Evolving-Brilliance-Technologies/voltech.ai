...
export function VirtualizedDataTable<TData>({
    ...
    return (
        <div
            className={cn(
                'my-4 rounded-sm border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 overflow-hidden',
                className || 'h-[600px]'
            )}
        >
            {/* Single scroll container for entire table */}
            <div
                                                    ...
                                                    <Table.Cell
                                                        ...
                                                        className={`px-4 py-3 border-r border-gray-100 dark:border-gray-700 border-b border-gray-100 dark:border-gray-800 last:border-r-0 text-xs ${align === "right"
                                                            ...
                                                            : align === "center"
                                                                ...
                                                                : dataType === "number"
                                                                    ? "font-medium text-green-600 dark:text-blue-400"
                                                                    : dataType === "date"
                    ...
                    {showFooter && (
                        <Table.Footer className="sticky bottom-0 z-10 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
                            {table.getFooterGroups().map(footerGroup => (
                                ...
                                >
                                    {showIndex && (
                                        <Table.Cell className="w-12 border-t border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900" />
                                    )}
