...
function Messages() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col h-full md:p-6 p-4"
    >
      <div className="flex flex-col h-[calc(100vh-8rem)] md:h-[calc(100vh-10rem)] bg-white dark:bg-slate-900/50 rounded-2xl shadow-sm border border-gray-100 dark:border-white/10 overflow-hidden transition-colors duration-300">
        <div className="flex flex-1 overflow-hidden flex-col md:flex-row">
          {/* Chats List */}
          <div
            className={cn(
              "md:w-80 border-r border-gray-100 dark:border-white/10 flex flex-col bg-gray-50/30 dark:bg-slate-800/20",
              currentChat ? "hidden md:flex" : "flex w-full"
            )}
          >
          ...
          <div
            className={cn(
              "flex-1 flex flex-col bg-white dark:bg-transparent",
          ...
          >
            {currentChat ? (
              <>
                {/* Chat Header */}
                <div className="p-4 border-b border-gray-100 dark:border-white/10 flex justify-between items-center bg-white dark:bg-transparent">
                ...
                {/* Chat Messages */}
                <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 bg-gray-50/30 dark:bg-slate-950/10">
                  {messages.map(msg => (
                    <div
                      key={msg.id}
                      className={cn(
